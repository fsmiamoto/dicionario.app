...
export class OpenAIProvider {
  ...
  async generatePhrases(word: string, targetLanguage: string = 'Spanish', apiKey?: string): Promise<ExamplePhrase[]> {
    try {
      if (!apiKey) {
...
Return ONLY valid JSON in this exact format:
{
  ...
  async generateExplanation(word: string, targetLanguage: string = 'English', apiKey?: string): Promise<string> {
    try {
      console.log('OpenAI generateExplanation called for word:', word, 'in language:', targetLanguage);
